...
#
# Makefile for building IMX283 camera driver on Jetson (device tree overlay + kernel module)
...
# --- Device tree overlay ---
DTS := tegra234-p3767-camera-p3768-imx283-A.dts
DTBO := $(DTS:.dts=.dtbo)
...
KBUILD_SRCS := nv_imx283.c imx283_mode_tbls.h
...
all: $(BUILD_DIR)/$(DTBO) $(BUILD_DIR)/nv_imx283.ko
...
install: $(BUILD_DIR)/$(DTBO) $(BUILD_DIR)/nv_imx283.ko
